...
public class GoogleRecognitionServiceImpl extends AIService {
    ...
    protected void initializeRecognizer() {
        ...
        synchronized (speechRecognizerLock) {
            ...
            speechRecognizer = SpeechRecognizer.createSpeechRecognizer(context,
                    ComponentName.unflattenFromString("com.google.android.voicesearch/.GoogleRecognitionService"));
    ...
    private Intent createRecognitionIntent() {
        ...
        sttIntent.putExtra(RecognizerIntent.EXTRA_LANGUAGE, "vi_VN");
        ...
        public void onResults(final Bundle results) {
            if (recognitionActive) {
                ...
                if (recognitionResults == null || recognitionResults.isEmpty()) {
                    ...
                    // notify listeners about the last recognition result for more accurate user feedback
